...
public class Browser {
    ...
    private static final String AUTHORITY_URL = Constant.AUTHORITY;
     ...
     */
    public static final Uri BOOKMARKS_URI = Uri.parse("content://"+AUTHORITY_URL+"/bookmarks");
     ...
     * identifier.
     */
    public static final String EXTRA_APPLICATION_ID = "com.android."+AUTHORITY_URL+".application_id";
     ...
     * <p>
     */
    public static final String EXTRA_HEADERS = "com.android."+AUTHORITY_URL+".headers";
     ...
     * requires the {@link android.Manifest.permission#WRITE_HISTORY_BOOKMARKS} permission.
     */
    public static final Uri SEARCHES_URI = Uri.parse("content://"+AUTHORITY_URL+"/searches");
